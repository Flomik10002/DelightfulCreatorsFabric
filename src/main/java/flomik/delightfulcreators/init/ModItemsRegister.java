...
public class ModItemsRegister {
    public static final Item INCOMPLETE_VEGETABLE_NOODLES = registerItem("incomplete_vegetable_noodles",
            settings -> new Item(settings.craftRemainder(Items.BOWL).food(new FoodProperties.Builder().nutrition(3).saturationModifier(0.3f).build())));
    ...
    public static final Item INCOMPLETE_DUMPLINGS = registerItem("incomplete_dumplings",
            settings -> new Item(settings.food(new FoodProperties.Builder().nutrition(3).saturationModifier(0.3f).build())));
