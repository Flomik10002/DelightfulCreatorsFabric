...
public class ModFluidsRegister {
    ...
    public static void register() {
        ...
        STILL_BLAZING_CHILI = Registry.register(Registry.FLUID,
                new Identifier(DelightfulCreatorsMod.MOD_ID, "blazing_chili"), new BlazingChiliFluid.Still());
        FLOWING_BLAZING_CHILI = Registry.register(Registry.FLUID,
                new Identifier(DelightfulCreatorsMod.MOD_ID, "flowing_blazing_chili"), new BlazingChiliFluid.Flowing());
        BLAZING_CHILI_BLOCK = Registry.register(Registry.BLOCK, new Identifier(DelightfulCreatorsMod.MOD_ID, "blazing_chili_block"),
                new FluidBlock(ModFluidsRegister.STILL_BLAZING_CHILI, FabricBlockSettings.copyOf(Blocks.WATER)));
        BLAZING_CHILI_BUCKET = Registry.register(Registry.ITEM, new Identifier(DelightfulCreatorsMod.MOD_ID, "blazing_chili_bucket"),
        ...
        STILL_TEA_CURRY = Registry.register(Registry.FLUID,
                new Identifier(DelightfulCreatorsMod.MOD_ID, "tea_curry"), new TeaCurryFluid.Still());
        FLOWING_TEA_CURRY = Registry.register(Registry.FLUID,
                new Identifier(DelightfulCreatorsMod.MOD_ID, "flowing_tea_curry"), new TeaCurryFluid.Flowing());
        TEA_CURRY_BLOCK = Registry.register(Registry.BLOCK, new Identifier(DelightfulCreatorsMod.MOD_ID, "tea_curry_block"),
                new FluidBlock(ModFluidsRegister.STILL_TEA_CURRY, FabricBlockSettings.copyOf(Blocks.WATER)));
        TEA_CURRY_BUCKET = Registry.register(Registry.ITEM, new Identifier(DelightfulCreatorsMod.MOD_ID, "tea_curry_bucket"),
